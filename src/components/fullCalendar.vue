<template>
  <div class="content">
    <el-row :gutter="20" class="elRow">
      ...
      <el-col :span="14" class="elColMiddle"><div class="grid-content-middle">
        <div class="grid-content-header">
          <div class="headerLeft">
              我的日程
            <div class="type"><div style="background:#61B1FF"></div><span>个人</span></div>
            <div class="type"><div style="background:#E880D8"></div><span>工作</span></div>
            <div class="type"><div style="background:#F71701"></div><span>生日</span></div>
          </div>
      ...
      <el-col :span="5" class="elColright">
        <div class="grid-content bg-purple">
          <DadyFullCalendar></DadyFullCalendar>
        </div></el-col>
    </el-row>
    <!-- 新增日弹框 -->
...
export default {
  name: 'fullcalendar',
  components: {
    FullCalendar ,FullCalendarSeach,DadyFullCalendar,newDay
  },
  data () {
    return {
      buttonText: {
      ...
      calendarEvents: [ // init event list
        {
          title: 'Event Now',
          start: new Date(),
          color: '#61B1FF',
  ...
  methods: {
    ...
    submit (val) {
       ...
       if(val){
         let endD=new Date(val.endDate)
         let end=val.endDate?endD:''
         console.log(123)
         this.calendarEvents.push({ // add new event data
          title: val.name,
          start: val.startDate,
