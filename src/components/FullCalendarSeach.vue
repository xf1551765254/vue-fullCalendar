      ...
      <div>
        <el-form ref="form" :model="formData" size="mini" label-width="70px">
          ...
          <el-form-item label="日程类型">
            <el-select v-model="formData.colorType" placeholder="请选择" style="width:100%">
          ...
          <el-form-item label="重要性">
            <el-select v-model="formData.important" placeholder="请选择" style="width:100%">
        ...
        <el-collapse v-model="activeNames" @change="handleChange">
          ...
          >
            <el-timeline v-if="i.childen">
              ...
              >{{activity.timestamp}}</el-timeline-item>
            </el-timeline>
          </el-collapse-item>
        </el-collapse>
      </div>
